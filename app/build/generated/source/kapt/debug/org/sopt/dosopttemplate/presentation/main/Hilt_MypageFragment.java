...
public abstract class Hilt_MypageFragment<T extends ViewDataBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_MypageFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MypageFragment_GeneratedInjector) this.generatedComponent()).injectMypageFragment(UnsafeCasts.<MypageFragment>unsafeCast(this));
    }
  }
