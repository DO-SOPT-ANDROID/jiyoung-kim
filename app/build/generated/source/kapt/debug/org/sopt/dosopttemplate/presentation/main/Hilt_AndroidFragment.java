...
public abstract class Hilt_AndroidFragment<T extends ViewDataBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AndroidFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AndroidFragment_GeneratedInjector) this.generatedComponent()).injectAndroidFragment(UnsafeCasts.<AndroidFragment>unsafeCast(this));
    }
  }
